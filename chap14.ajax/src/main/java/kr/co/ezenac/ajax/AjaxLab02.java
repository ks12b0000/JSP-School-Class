...
public class AjaxLab02 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		result = "<main><book>" +
				 "<title><![CDATA[Spring Security 3/e]]></title>" +
				 "<writer><![CDATA[믹 넛슨]]></writer>" +
				 "<image><![CDATA[http://localhost8080/chap14.ajax/image/image.jpg]]></image>" +
				"</book>"
				+ "<book>" +
				"<title><![CDATA[함수형 코틀린]]></title>" +
				 "<writer><![CDATA[마리오 아리아스]]></writer>" +
				 "<image><![CDATA[http://localhost8080/chap14.ajax/image/image2.jpg]]></image>" +
				"</book>"
				+ "</main>";
